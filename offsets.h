...
namespace OFFSETS
{
    uintptr_t Gameinstance = 0x1A8; //UWorld OwningGameInstance
    uintptr_t LocalPlayers = 0x38; //UGameInstance
    uintptr_t PlayerController = 0x30; //UPlayer
    uintptr_t LocalPawn = 0x310;
    uintptr_t PlayerState = 0x290; //APawn
    uintptr_t RootComponet = 0x188; //AActor
    uintptr_t PersistentLevel = 0x30; //UWorld
    uintptr_t ActorCount = 0xA0;
    uintptr_t AActor = 0x98;
    uintptr_t CurrentActor = 0x8;
    uintptr_t Mesh = 0x2F0; //ACharacter
    uintptr_t TeamId = 0x1048; //AFortPlayerStateAthena
